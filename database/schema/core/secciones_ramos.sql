CREATE TABLE Secciones_Ramos(
    ...
    jornadas ENUM("DIURNA", "VESPERTINA", "NOCTURNA", "MIXTA") NOT NULL,
    cupos_totales INT NOT NULL,
    cupos_ocupados INT NOT NULL,
    cupos_disponibles INT GENERATED ALWAYS AS (cupos_totales - cupos_ocupados) STORED,
