...
(
	'12.345.678-9', 5, 2, 0, 'Camila Rojas', 'Ingeniería en Informática', 'Luis Rojas',
	FALSE, TRUE, FALSE, FALSE, FALSE, TRUE, 'NUEVO', 'MATRICULADO', 6.2, 6.0, 5.8, '2026-01-28'
),
(
	'9.876.543-2', 4, 1, 85, 'Diego Pérez', 'Administración de Empresas', 'Marta Pérez',
	FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, 'VIEJO', 'ACTIVO', 5.4, 5.8, 5.1, '2026-01-30'
),
(
	'18.234.567-1', 6, 0, 70, 'Valentina Soto', 'Trabajo Social', 'Carolina Soto',
	FALSE, TRUE, TRUE, TRUE, FALSE, FALSE, 'VIEJO', 'PENDIENTE', 5.9, 6.1, 5.6, '2025-12-15'
),
(
	'7.654.321-0', 3, 3, 0, 'Javier Morales', 'Analista Programador', 'Ana Morales',
	TRUE, FALSE, FALSE, FALSE, FALSE, TRUE, 'VIEJO', 'MATRICULADO', 6.5, 6.3, 6.0, '2026-01-27'
),
(
	'21.345.987-6', 5, 1, 80000, 'Fernanda López', 'Contabilidad', 'Rosa López',
